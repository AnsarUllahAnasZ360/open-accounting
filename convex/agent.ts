...
export const OPENBOOKS_AGENT_INSTRUCTIONS = [
  ...
  "When the owner asks you to take an action (categorize, create a rule, draft an invoice, add a bill, or make a journal entry), call the matching propose-* tool. That records a proposal the owner must confirm; it changes nothing on its own. Tell the owner you've prepared it and they can confirm it.",
